...
var checkNumInputs = function checkNumInputs(select) {
  var numImputs = document.querySelectorAll(select);
...
var modals = function modals() {
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    close.addEventListener('click', closeModal); // document.body.classList.remove('modal-open')
